#include <featherkit/input/sdlinputbackend.hpp>
...
namespace fea
{
    ...
    bool SDLInputBackend::isGamepadConnected(uint32_t id)
    {
        (void)id;
        //not sure
        return true;
    ...
    uint32_t SDLInputBackend::getGamepadButtonCount(uint32_t id)
    {
        (void)id;
        //not sure
        return 0;
    ...
    bool SDLInputBackend::isGamepadButtonPressed(uint32_t id, uint32_t button)
    {
        (void)id;
        (void)button;
        //not sure
    ...
    bool SDLInputBackend::gamepadHasAxis(uint32_t id, Gamepad::Axis axis)
    {
        (void)id;
        (void)axis;
        //not sure
    ...
    float SDLInputBackend::getGamepadAxisPosition(uint32_t id, Gamepad::Axis axis)
    {
        (void)id;
        (void)axis;
        //not sure
    ...
    Event SDLInputBackend::resized(SDL_Event& event)
    {
        Event result;

        result.type = Event::RESIZED;
        result.size.width = (uint32_t)event.resize.w;
        result.size.height = (uint32_t)event.resize.h;

        return result;
    }

    Event SDLInputBackend::active(SDL_Event& event)
    {
        //TBI
        (void) event;
        Event result;
    ...
    Event SDLInputBackend::keyPressed(SDL_Event& event)
    {
        Event result;
    ...
    Event SDLInputBackend::keyReleased(SDL_Event& event)
    {
        Event result;
    ...
    Event SDLInputBackend::mouseButtonPressed(SDL_Event& event)
    {
        Event result;
    ...
    Event SDLInputBackend::mouseButtonReleased(SDL_Event& event)
    {
        Event result;
    ...
    Event SDLInputBackend::mouseMoved(SDL_Event& event)
    {
        Event result;
    ...
    Event SDLInputBackend::gamepadButtonPressed(SDL_Event& event)
    {
        //TBI
        Event result;
    ...
    Event SDLInputBackend::gamepadButtonReleased(SDL_Event& event)
    {
        //TBI
        Event result;
    ...
    Event SDLInputBackend::gamepadMoved(SDL_Event& event)
    {
        //TBI
        Event result;
    ...
    void SDLInputBackend::setGamepadThreshold(float threshold)
    {
        //TBI
    ...
    void SDLInputBackend::setKeyRepeatEnabled(bool enabled)
    {
        //TBI
    ...
    uint8_t SDLInputBackend::feaMouseButtonToSdl(Mouse::Button feaMouseButton) const
    {
    ...
    Mouse::Button SDLInputBackend::sdlMouseButtonToFea(uint32_t sdlMouseButton) const
    {
