...
std::vector<typename Pathfinder<NodeProvider>::Node> Pathfinder<NodeProvider>::findPath(NodeProvider& nodes, const Node& start, const Node& target, uint32_t costLimit)
{   
