...
namespace fea
{
     ...
     ***
     *  @fn Colour(float r, float g, float b, float a = 1.0f)
     ...
     ***
     *  @fn Colour(int32_t r, int32_t g, int32_t b, int32_t a = 255);
     ...
     ***
     *  @fn Colour(int32_t hexValue, int32_t a = 255);
     ...
     *  @param a Alpha channel value from 0 to 255.
     ***
     *  @fn Colour(int32_t hexValue, float a);
     *  @brief Construct a colour from a hexadecimal value and its alpha channel from a float.
     *  @param hexValue The colour value from 0x000000 to 0xFFFFFF.
     *  @param a Alpha channel value from 0.0f to 1.0f.
     ***
     *  @fn Colour operator+(const Colour& other) const
     ...
     ***
     *  @fn Colour& operator+=(const Colour& other)
     ...
     *  @return The final result of this colour.
     ***
     *  @fn bool operator==(const Colour& other) const
